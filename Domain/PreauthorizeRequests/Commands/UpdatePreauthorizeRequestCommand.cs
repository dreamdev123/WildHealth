...
public class UpdatePreauthorizeRequestCommand : IRequest<PreauthorizeRequest>, IValidatabe
{
    public int Id { get; }
    ...
    public UpdatePreauthorizeRequestCommand(
        int id,
        string firstName,
        string lastName,
        string email,
    ...
    private class Validator : AbstractValidator<UpdatePreauthorizeRequestCommand>
    {
        public Validator()
        {
