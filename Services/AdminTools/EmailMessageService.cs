...
public class EmailMessageService : MessageServiceBase
{
    ...
    /// <summary>
    /// Sending messages to email by message filter
    /// </summary>
    ...
    public override async Task SendMessageAsync(int messageId, MyPatientsFilterModel filterModel)
    {
        ...
        var notification = new MessageAdminToolEmailNotification(message: message, users: allUsers);
