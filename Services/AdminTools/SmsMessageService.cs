...
public class SmsMessageService: MessageServiceBase
{
    ...
    public override async Task SendMessageAsync(int messageId, MyPatientsFilterModel filterModel)
    {
        ...
        var notification = new MessageAdminToolSMSNotification(message: message, users: allUsers.Where(x => !string.IsNullOrEmpty(x.PhoneNumber)).ToArray());
