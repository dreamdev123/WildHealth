...
public class PublishConversationParticipantRemovedEventCommand : IRequest, IValidatabe
{
    ...
    public PublishConversationParticipantRemovedEventCommand(
    ...
    private class Validator : AbstractValidator<PublishConversationParticipantRemovedEventCommand>
    {
        public Validator()
        {
