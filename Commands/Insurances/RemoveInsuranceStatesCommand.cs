...
public class RemoveInsuranceStatesCommand : IRequest<Insurance>, IValidatabe
{
    public int InsuranceId { get; }
    
    public StateModel[] States { get; }

    public RemoveInsuranceStatesCommand(int insuranceId, StateModel[] states)
    {
    ...
    private class Validator : AbstractValidator<RemoveInsuranceStatesCommand>
    {
        public Validator()
        {
